...
export const levelsArr: LevelI[] = [
  ...
  },
  {
    ...
    svgMarkup: [
      ...
      {
        tag: "square",
        children: [{ tag: "triangle", class: ["medium", "orange", "glowing"] }],
      },
      { tag: "circle" },
    ],
    htmlMarkup: [
  ...
  },
  {
    ...
    svgMarkup: [
      ...
      {
        tag: "circle",
        children: [{ tag: "square", class: ["medium", "glowing"], id: "romb" }],
      },
    ],
    htmlMarkup: [
      "<square></square>",
  ...
  },
  {
    ...
    svgMarkup: [
      ...
      {
        tag: "circle",
        children: [{ tag: "triangle", class: ["medium", "glowing"] }],
      },
    ],
    htmlMarkup: [
      "<square>",
  ...
  },
  {
    ...
    svgMarkup: [
      {
        tag: "circle",
        children: [{ tag: "square", class: ["medium", "glowing"] }],
      },
      {
        tag: "circle",
        children: [{ tag: "triangle", class: ["medium", "glowing"] }],
      },
      {
        ...
        children: [
          {
            tag: "square",
            class: ["medium", "glowing"],
            children: [{ tag: "triangle", class: ["small", "glowing"] }],
          },
        ],
      },
    ],
